...
# __modification time__ = Last modified: 2026-07-19T16:26:55
...
def creat_input(scenario_idx):
    ...
    # TODO Changed here
    scenario_bound = Path(project_root) / "pipeline/run_whatif_Rs2d=0.05/scenario_bound.txt"
...
if __name__ == "__main__":
    ...
    for theta_draw_idx in range(num_draw):
        ...
        output_ls_dir = f"{project_root}/data/SedCas_ls_monitor_MAP" # use monitoring ls
