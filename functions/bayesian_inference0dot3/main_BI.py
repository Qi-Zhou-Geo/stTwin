...
def load_config():
    ...
    params_trial = {"project_root": current_dir.parent.parent,
                    "output_dir": f"{current_dir.parent.parent}/functions/bayesian_inference0dot3/output",
...
if __name__ == "__main__":
    ...
    moves = [
        (emcee.moves.StretchMove(a=2.0), 0.6), # 60% use the default StretchMove
        (emcee.moves.DEMove(), 0.4), # 40% use the DEMove
    ]
