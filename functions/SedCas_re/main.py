...
#
# # (5) visualize
t1, t2 = "2017-01-01T00:00:00", "2018-01-01T00:00:00"
mask = (model.hydro_output.time_str >= t1) & (model.hydro_output.time_str < t2)
hydro_output_2017 = model.hydro_output.isel(time=mask)

time_coord = "time_str"
# list_of_col_names = [(time_coord, "snow_acc"), (time_coord, "snow_melt"),
#                      (time_coord, "Q"), (time_coord, "Qs"), (time_coord, "Qss"),
#                      (time_coord, "PET"), (time_coord, "AET")]
list_of_col_names = [(time_coord, "snow_acc"), (time_coord, "snow_melt"),
                     (time_coord, "PET"), (time_coord, "AET")]
