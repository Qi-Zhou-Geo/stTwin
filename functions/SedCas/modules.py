...
#__note__ = The code was modified from SedCas (author=Jacob Hirschberg, created=2022-02-03, source=https://github.com/jacobhirschberg/SedCas) under the GPL-3.0 License.
...
#ET_PT(dt=1, Rsw=self.Rsw, Ta=self.Ta, N=1, A=s.albedo, Ele=self.Ele, U=0.8, d=1, 1, 1, 0, 0)
...
# h = SedCas_h_model.hydmod(s, pet, self.Pr, self.Ta, self.alphaET, len(self.Vwcaps[i]), {'k':self.ks[i], 'Scap':self.Vwcaps[i], 'S0':[0,0]})
