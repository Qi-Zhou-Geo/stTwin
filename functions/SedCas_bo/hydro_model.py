...
def area_weight_aggregate(hydro_container, weights):
    ...
    for var in vars_to_aggregat:
        ...
        agg.attrs = hydro_container[var].attrs.copy()
        aggregated_data[var] = agg

    # Keep w_storage as is (with HRU_id dimension)
    aggregated_data['w_storage'] = hydro_container['w_storage']
    aggregated_data['w_storage'].attrs = hydro_container['w_storage'].attrs.copy()
    ...
    hydro_output = xr.Dataset(
        ...
        coords={
            ...
            'HRU_id': hydro_container.coords['HRU_id'],
        },
        attrs=hydro_container.attrs.copy()
    )
