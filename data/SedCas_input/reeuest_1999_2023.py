...
def request_1h_data(time_resolution="Hourly"):
    ...
    df0 = fetch_data4SedCas(station="mve", time_resolution=time_resolution,  time_period="1990-1999")
    df0 = replace_nan(df0, default_value = 0)

    df1 = fetch_data4SedCas(station="mve", time_resolution=time_resolution,  time_period="2000-2009")
    df1 = replace_nan(df1, default_value = 0)

    df2 = fetch_data4SedCas(station="mve", time_resolution=time_resolution,  time_period="2010-2019")
    df2 = replace_nan(df2, default_value = 0)

    df3 = fetch_data4SedCas(station="mve", time_resolution=time_resolution,  time_period="2020-2029")
    ...
    time1 = "1999-10-01T00:00:00" # 10 minutes data start at 2004-02-01T00:00:00
