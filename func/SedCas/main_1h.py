...
# __modification time__ = Last modified: 2026-06-12T11:48:19
...
print(f"Note:\n"
      f"The model's input params are from JH.")

# (1) initial the SedCas model
model_params = "SedCas_input_params_1h_QZ.yaml"
