...
# __modification time__ = Last modified: 2026-06-16T16:45:34
...
ax_twin.set_ylabel("Sediment Yield\n" + r"[$\mathrm{m}^3$" + " / 10 minutes]", fontweight='bold', color="black")
...
ax_twin.plot(x_qs, data, color="black", label="Modelled: Surface Discharge", alpha=0.75)
ax_twin.set_ylabel("Modelled Discharge\n" + r"[$\mathrm{m}^3$" + " / 10 minutes]", fontweight='bold', color="black")
