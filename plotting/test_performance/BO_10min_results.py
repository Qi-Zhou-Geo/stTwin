...
sed_output = xr.open_dataset(f"{project_root}/functions/SedCas_bo/10min/sed_output_2004_2018.nc")
...
sed_output = xr.open_dataset(f"{project_root}/functions/SedCas_bo/10min/sed_container_2004_2018.nc")
