...
sed_output = xr.open_dataset(f"{project_root}/functions/SedCas/1h/sed_output_2004_2018.nc")
...
sed_output = xr.open_dataset(f"{project_root}/functions/SedCas/1h/sed_container_2004_2018.nc")
